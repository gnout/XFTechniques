...
[assembly: ExportEffect(typeof(Etude.iOS.Effects.ImageButtonTintEffect), nameof(Etude.Effects.ImageButtonTintEffect))]
        ...
        private void UpdateTintColor()
        {
            try
            {
                if (this.Control is UIButton imagebutton)
                {
                    ...
                    imagebutton.ImageView.TintColor = Etude.Effects.ImageButtonTintEffectParameters.GetTintColor(this.Element).ToUIColor();
                    imagebutton.TintColor = Etude.Effects.ImageButtonTintEffectParameters.GetTintColor(this.Element).ToUIColor();
